/*
Codigo placa 3,  tiene el sensor de humedad conectado al pin GPI036 de la placa ESP32 y el sensor se temperatura conectado mediante I2C, 
...
//  token
#define TOKEN               "ypDDzTsFGbIhu5sBeAWx"
// IP ThingsBoard 
...
if (contador>=20){
  ...
  String temperature3 = String(temperature);
  String SensorValue3 = String(SensorValue);
  
String payload = "{";
  payload += "\"Temperatura3\":"; payload += temperature3; payload += ",";
  payload += "\"Humedad3\":"; payload += SensorValue3;
  payload += "}";
